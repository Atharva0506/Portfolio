...
keywords:
    ...
    - fastapi sse streaming tutorial
    - ai news aggregator architecture
    - solana subscription payments integration
    - rag pipeline design for news
...
- **Live Application**: [https://newsai.atharvanaik.me/](https://newsai.atharvanaik.me/)
...
graph TD
    START([START]) --> Collector["🔍 Collector Node<br/>Quality Analysis"]
    
    Collector --> CheckQuality{Check Quality<br/>Score < 0.3?}
    
    CheckQuality -->|Yes| END1([END])
    CheckQuality -->|No| Classifier["📂 Classifier Node<br/>Category, Sentiment, Tags"]
    
    Classifier --> Summarizer["📝 Summarizer Node<br/>Short & Detail Summary"]
    
    Summarizer --> Bias["⚖️ Bias Node<br/>Bias Score & Analysis"]
